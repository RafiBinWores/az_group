                                ...
                                $("#side-menu a").each(function () {
                                    ...
                                    this.href == t &&
                                        ...
                                        (t = $(this)
                                            ...
                                            .parent()
                                            .parent()).is("body") ||
                                            t.addClass("menuitem-active"));
                                })),
                            $("#two-col-sidenav-main").length &&
                                ((n = $("#two-col-sidenav-main .nav-link")),
            ...
            _createClass(t, [
                ...
                },
                {
                    ...
                    value: function () {
                        var t = this;
                        null !==
                            (e = document.querySelector(".right-bar-toggle")) &&
                            void 0 !== e &&
                        ...
                        e.forEach(function (n) {
                            n.addEventListener("click", function (t) {
                                ...
                                n.parentElement.classList.contains(
                                    ...
                                    ((a = !0),
                                    n.parentElement.parentElement.classList.add(
                                        "show"
                                    ),
                                    ((e =
                                        n.parentElement.parentElement.parentElement.querySelector(
                                            ".nav-link"
                                        )).ariaExpanded = !0),
                                    e.classList.add("show"),
                                    bootstrap.Dropdown.getInstance(n).show());
                            }),
                                n.addEventListener(
                                    "hide.bs.dropdown",
                                    function (t) {
            ...
            _createClass(t, [
                {
                    ...
                    value: function () {
                        $(document).on("click", "body", function (t) {
                            1 !== $(t.target).closest("#top-search").length &&
            ...
            _createClass(t, [
                {
                    ...
                    value: function () {
                        var t,
                            e = JSON.parse(JSON.stringify(this.defaultConfig));
                        (e.leftbar.color =
                            null !==
                                (t =
                ...
                },
                {
                    ...
                    value: function (t) {
                        (this.config.leftbar.color = t),
                            this.body.setAttribute("data-leftbar-color", t),
                            this.setSwitchFromConfig();
                    },
                },
                {
                    ...
                    value: function (t) {
                        (this.config.leftbar.position = t),
                            this.body.setAttribute("data-leftbar-position", t),
                            this.setSwitchFromConfig();
                    },
                },
                {
                    ...
                    value: function (t) {
                        (this.config.leftbar.size = t),
                            this.body.setAttribute("data-leftbar-size", t),
                            this.setSwitchFromConfig();
                    },
                },
                {
                    ...
                    value: function (t) {
                        (this.config.layout.mode = t),
                            this.body.setAttribute("data-layout-mode", t),
                            this.setSwitchFromConfig();
                    },
                },
                {
                    ...
                    value: function (t) {
                        (this.config.layout.color = t),
                            this.body.setAttribute("data-layout-color", t),
                            this.setSwitchFromConfig();
                    },
                },
                {
                    ...
                    value: function (t) {
                        (this.config.layout.size = t),
                            this.body.setAttribute("data-layout-size", t),
                            this.setSwitchFromConfig();
                    },
                },
                {
                    ...
                    value: function (t) {
                        (this.config.topbar.color = t),
                            this.body.setAttribute("data-topbar-color", t),
                            this.setSwitchFromConfig();
                    },
                },
                {
                    ...
                    value: function (t) {
                        (this.config.sidebar.user = t)
                            ? this.body.setAttribute("data-sidebar-user", t)
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        document
                            ...
                            null !==
                                (t = document.querySelector("#resetBtn")) &&
                                void 0 !== t &&
                    ...
                    o('[data-plugin="peity-bar"]').each(function (t, e) {
                        var n = o(this).attr("data-colors")
                            ...
                            i = o(this).attr("data-height")
                                ? o(this).attr("data-height")
                                : 20;
                        o(this).peity("bar", { fill: n, width: a, height: i });
                    });
            }),
                ...
                t &&
                    document
                        ...
                        .addEventListener("change", function () {
                            t.dataset.originalClass ||
                                (t.dataset.originalClass = t.className),
                                (t.className =
                                    t.dataset.originalClass + " " + this.value);
                        });
