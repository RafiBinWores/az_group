...
class EmbroideryExport implements FromCollection, WithHeadings, WithEvents, WithTitle
{
    protected $report;

    public function __construct(Embroidery $report)
    {
        $this->report = $report;
    }
    ...
    public function collection()
    {
        ...
        foreach ($this->report->embroidery_data as $row) {
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // Borders for table
                $rowCount = count($this->report->embroidery_data);
    ...
    {
        return 'Embroidery Print Report';
    }
}
