<x-layouts.app>
    <x-slot name="title">Production Reports</x-slot>
    <x-slot name="pageTitle">Production Reports</x-slot>
            ...
            <div class="row justify-content-between">
                <div class="col-md-4">
                    @can('edit-production-report')
                        ...
                        <a href="{{ route('productions.create') }}" class="btn btn-success waves-effect waves-light"><i
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title mb-3">Print List</h4>
