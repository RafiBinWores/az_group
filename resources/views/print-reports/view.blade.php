<x-layouts.app>
    <x-slot name="title">Print Reports</x-slot>
    <x-slot name="pageTitle">Print Reports</x-slot>
            ...
            <div class="row justify-content-between">
                <div class="col-md-4">
                    <div class="mt-3 mt-md-0">
                        <a href="{{ route('prints.create') }}" class="btn btn-success waves-effect waves-light"><i
